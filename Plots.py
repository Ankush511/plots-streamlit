...
st.header('2. Data Visualization using matplotlib and seaborn')
st.subheader('2.1 Loading the DataFrame')
df = pd.read_csv('/Users/Ankush/Desktop/Data Science/Streamlit/iris.csv')
st.dataframe(df)
...
st.subheader('3.1 Multiple Graphs using seaborn')
